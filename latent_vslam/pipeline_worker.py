...
from latent_vslam.execution_runtime import apply_cpu_profile, apply_runtime, runtime_provenance
from latent_vslam.staged_transfer import PinnedTransfer, shared_array
...
def run(config, component, logical_device):
    ...
    if component == "encoder":
        from prediction.jepa_worker import _load
        ...
        from prediction.predictor import predictor_state_sha256
        ...
        try:
            ...
            with torch.inference_mode():
                ...
                if component == "encoder":
                    ...
                    from latent_vslam.jepa_fmap import FullFOVTransform
