"""Capability-isolated delayed/bracketed prediction replay."""
...
from latent_vslam.jepa_fmap import coordinate_masks, preprocess_full_fov_rgb, tokens_to_field
from prediction.jepa_runtime import JepaSidecar, load_dpvo_domain
from latent_vslam.oracle_packet import FMapZeroContextPacket
from prediction.predictor import AnchorInterval
from latent_vslam.profiling import OnlineProfiler
from latent_vslam.runtime import AnchorRGBObservation, PacketObservation
from prediction.transport import (RobustCorrespondence, estimate_robust_correspondence,
...
class DelayedDeploymentProvider:
    ...
    def prepare_online(self) -> dict[str, Any]:
        ...
        return self._sidecar.prepare_online("prediction_matched_online")

    def flush_online(self) -> dict[str, Any]:
        if self._sidecar is None:
            raise RuntimeError("deployment sidecar is not active")
        result = self._sidecar.flush_online("prediction_matched_online")
    ...
    def usage_payload(self) -> dict[str, Any]:
        ...
        return {
            "provider_schema": "native_anchor_delayed_capability",
