...
helpers used by the Train/Infer runners and their summaries.
"""
...
class PerformanceRecorder:
    ...
    def stage(self, name: str, *, cuda: bool = True) -> Iterator[None]:
        ...
        if cuda and self.enable_cuda:
            ...
            torch.cuda.nvtx.range_push(f"prediction_efficiency::{name}")
            nvtx_active = True
            start_event.record()
    ...
    def payload(self) -> dict[str, Any]:
        ...
        return {
            "schema": "prediction_efficiency_exclusive_timing_v1",
...
class TransferLedger:
    ...
    def payload(self) -> dict[str, Any]:
        ...
        return {"schema": "prediction_transfer_ipc_audit_v1", "operations": result}
...
def logical_physical_mapping(
    ...
    from latent_vslam.cuda_devices import logical_device_telemetry
