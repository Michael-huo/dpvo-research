...
from latent_vslam.protocol import REPO_ROOT
...
class GPUWorker:
    ...
    def __init__(self, *, python, device, component, config_path, timeout=120.,
        ...
        env = os.environ.copy()
        command = [str(python), "-m", "latent_vslam.pipeline_worker",
        ...
        try:
            ...
            from latent_vslam.cuda_devices import validate_worker_binding
