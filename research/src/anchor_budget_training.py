"""Fresh predictors per budget, with the frozen H2 training implementation."""
...
from .jepa_runtime import (RestrictedFeatureView, extract_block5_store,
...
def fresh_train_budget(records, budget, protocol, config, output, temporary):
    ...
    try:
        ...
        teacher = RestrictedFeatureView(teacher_store, {i.key for i in _hidden_identities(test)},
                                        "anchor_budget_held_out_true_fmap")
