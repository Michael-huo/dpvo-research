...
from prediction.predictor import RobustTransportBlock5Predictor, predictor_metadata, predictor_state_sha256
from latent_vslam.protocol import atomic_write_bytes, canonical_sha256, repo_path, sha256_file
...
def load_canonical_predictor(config):
    ...
    path = repo_path(config["paths"]["predictor"])
