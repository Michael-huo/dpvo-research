"""Shared V-JEPA/DPVO feature IO used by Train and Infer."""
...
from latent_vslam.jepa_fmap import derive_full_fov_transform, preprocess_full_fov_rgb
from latent_vslam.protocol import REPO_ROOT, FrameIdentity, atomic_write_json, canonical_sha256, repo_path
...
class JepaSidecar:
    def __init__(self, config: Mapping[str, Any], temporary: Path) -> None:
        from latent_vslam.execution_runtime import capture_runtime
